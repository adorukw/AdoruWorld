...
const { dexEntries, dexStats } = dexStore
...
<template>
    <Layout>
            ...
            <div class="max-w-6xl mx-auto px-4 relative z-10">
                <div class="text-center">
                    <div class="inline-block mb-4">
                        <div class="w-20 h-20 bg-pokemon-red rounded-lg border-4  mx-auto mb-4
        ...
        <section class="py-6 border-y-4  overflow-hidden relative">
            <div class="absolute inset-0 sky-gradient"></div>
            <div class="max-w-6xl mx-auto px-4 relative z-10">
                <div class="grid grid-cols-3 md:grid-cols-7 gap-3">
                    <div v-for="cat in dexCategories" :key="cat.id"
                        class="text-center p-3 cursor-pointer transition-all border-4 rounded-lg" :class="selectedCategory === cat.id
                            ? ' shadow-md'
                            : 'border-transparent hover:/50'"
                        ...
                        <div class="text-xs text-pokemon-dark-gray mt-1">{{ dexStats.byCategory[cat.slug] || 0 }}</div>
                    </div>
                </div>
            </div>
        </section>
        ...
        <section class="py-8">
            <div class="max-w-6xl mx-auto px-4">
                ...
                <div class="flex items-center gap-4 mb-6 p-4 bg-white/80 rounded-lg border-4 ">
                    <div class="flex items-center gap-2">
