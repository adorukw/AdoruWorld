            ...
            <div class="max-w-6xl mx-auto px-4">
                    ...
                    <div class="flex flex-wrap gap-2 items-center">
                        ...
                        >
                            ...
                            <button
                                ...
                                "
                                class="right-20 w-6 h-6 flex items-center justify-center bg-gray-200 hover:bg-gray-300 border-2 border-black"
                                title="清空"
                            >
                                ✕
                            </button>
                        ...
                        <button
                            v-if="route.query.category || route.query.tag"
                            @click="clearFilters"
                ...
                <div v-else class="text-center py-16">
                    ...
                    <div class="flex justify-center gap-4">
                        ...
                        <router-link
                            to="/archives"
                            class="pixel-btn bg-gold hover:bg-gold-dark"
                        >
                            浏览归档
                        </router-link>
                    </div>
