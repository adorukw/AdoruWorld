                ...
                <div class="max-w-4xl mx-auto px-4">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div class="md:col-span-1">
                            <div
                                class="pixel-card overflow-hidden sticky top-24"
                            >
                                <div class="relative aspect-3/4">
                                    ...
                                    <div
                                        class="absolute top-3 left-3 right-3 flex justify-between"
                                    >
                                        <span
                                            class="text-sm px-3 py-1 border-3 text-white pixel-text"
                                            :style="{
                                                backgroundColor:
                                                    categoryInfo?.color,
                                            }"
                                    ...
                                    >
                                        <div
                                            class="bg-white/90 backdrop-blur-sm rounded border-3p-2"
                                        >
                                            <div class="text-xs">
                                                #{{
                                                    String(dexIndex).padStart(
                                                        3,
                                                        "0",
                                                    )
                                                }}
                            ...
                            <div v-if="dex.summary" class="pixel-card p-5 mt-6">
                                <h2
                                    class="text-sm mb-3 flex items-center gap-2"
                                >
                                    <span>📖</span> 作品简介
                                </h2>
                                <p
                        ...
                        <div class="md:col-span-2">
                            <div class="pixel-card p-6 mb-6">
                                ...
                                >
                                    ...
                                    <span
                                        class="shrink-0 text-sm px-4 py-2 border-4 text-white pixel-text"
                                        :style="{
                                ...
                                <div v-if="dex.rating > 0" class="mb-6">
                                    <div class="flex items-center gap-3 mb-2">
                                        ...
                                        <span class="text-lg text-gold-dark"
                                            >{{ dex.rating }}/10</span
                                        >
                                    </div>
                                    <div
                                        class="text-gold text-lg tracking-wider"
                                    >
                                ...
                                <div class="grid grid-cols-2 gap-4 mb-6">
                                    <div
                                        v-if="dex.creator"
                                        class="bg-[#7893e9] p-3 rounded border-2"
                                    >
                                    ...
                                    <div
                                        v-if="dex.year"
                                        class="bg-[#d79769] p-3 rounded border-2"
                                    >
                                    ...
                                    <div
                                        v-if="dex.startDate"
                                        class="bg-[#e66a6a] p-3 rounded border-2"
                                    >
                            ...
                            >
                                ...
                                >
                                    <router-link
                                        v-for="related in relatedDexs"
                                        :key="related.id"
                                        :to="`/dex/${related.slug}`"
                                        class="group"
                                    >
                                        <div
                                            class="aspect-3/4 overflow-hidden rounded border-2 mb-2"
                                        >
                                            <img
                                        ...
                                        <div
                                            class="text-xs line-clamp-1 group-hover:text-sky-dark"
                                        >
                                            {{ related.title }}
                                        </div>
                                    </router-link>
