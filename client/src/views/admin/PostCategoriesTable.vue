...
<template>
            ...
            <table class="w-full">
                ...
                <tbody>
                    <tr v-for="item in items" :key="item.id" class="border-b-2 border-gray-200 hover:bg-gray-50">
                        ...
                        <td class="p-4">
                            <span class="px-2 py-1 bg-grass-light border-2 border-black  text-xs">
                                {{ item.count }} 篇
                            </span>
                        </td>
                        <td class="p-4">
    ...
    <CrudModal v-if="showModal" module="postCategories" :mode="modalMode" :initial-data="editingItem"
