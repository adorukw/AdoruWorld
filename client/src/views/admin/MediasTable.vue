...
const {
    ...
    fetchFn: (params: { skip?: number; limit?: number }) =>
        mediaStore.getMedias(params),
    pageSize: 5,
});

const showModal = ref(false);
const modalMode = ref<"create" | "update">("create");
const editingItem = ref<MediaResponse | null>(null);
            ...
            <table class="w-full">
                ...
                <tbody>
                    ...
                    >
                        ...
                        <td class="p-4">
                            <span
                                class="px-2 py-1 bg-purple-200 border-2 border-black text-xs"
                            >
                                {{ item.mediaType }}
                            </span>
                        </td>
