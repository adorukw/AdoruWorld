<template>
    ...
    >
        <div
            class="pixel-card bg-yellow-300 p-4 w-full transition-all duration-200 hover:-translate-y-1 hover:shadow-[6px_6px_0px_0px_rgba(0,0,0,0.8)] relative"
            :style="cardStyle"
        >
            <!-- 编号和分类 -->
            ...
            <!-- 图片区域 -->
            <div
                class="aspect-square overflow-hidden mb-4 flex items-center justify-center border-2 border-black"
            >
                <div
                    class="w-full h-full bg-yellow-200 flex items-center justify-center relative"
                >
                    <img
            ...
            <div class="h-14 flex items-center justify-center mb-2">
                <h3
                    class="text-lg text-center text-gray-900 line-clamp-2 overflow-hidden"
                >
                    {{ entry.title }}
                </h3>
            </div>
            ...
            <div
                v-if="entry.rating > 0"
                class="text-center text-gold-dark mb-2"
            >
            ...
            <!-- 查看详情按钮 -->
            <button
                class="w-full bg-red-500 hover:bg-red-600 text-white py-2 font-bold relative active:translate-x-0.5 active:translate-y-0.5 active:shadow-[2px_2px_0px_0px_rgba(0,0,0,0.8)] transition-all duration-100"
                :style="buttonStyle"
            >
                查看详情
            </button>
    ...
    <router-link v-else :to="`/dex/${entry.slug}`" class="block">
        <div class="pixel-card p-4 flex gap-4 items-center bg-white">
            <!-- 封面图 -->
            <div
                class="w-35 h-35 shrink-0 overflow-hidden rounded border-2 border-black"
            >
                <img
                    :src="entry.coverImage"
                    :alt="entry.title"
            ...
            <div class="flex-1 min-w-0">
                ...
                <p
                    ...
                    class="text-pokemon-dark-gray mb-2 truncate"
                >
                    {{ entry.originalTitle }}
                </p>
            ...
            <div class="shrink-0 text-right">
                ...
                <div
                    class="w-20 h-2 bg-pokemon-gray rounded-full overflow-hidden border mt-1"
                >
                    <div
