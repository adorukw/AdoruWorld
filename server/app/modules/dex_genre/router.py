...
from . import crud
from .schema import DexGenreCreate, DexGenreResponse, DexGenreUpdate
...
async def get_genre_by_slug(slug: str, db: Annotated[AsyncSession, Depends(get_db)]):
...
async def get_genre_by_id(genre_id: str, db: Annotated[AsyncSession, Depends(get_db)]):
